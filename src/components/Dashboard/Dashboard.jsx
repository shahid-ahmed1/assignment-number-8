    ...
    return (
        <div>
                   ...
                   <NavLink to='addtocart' className={({isActive})=> (isActive?'text-orange-500 text-lg ':'hover:bg-orange-500 text-lg ')}>  <button   className='btn text-xl rounded-4xl text-white px-10 bg-[#9538E2]'>Cart</button></NavLink>
                    <NavLink  className={({isActive})=> (isActive?'text-orange-500 text-lg ':'hover:bg-orange-500 text-lg ')}><button className='btn text-xl ml-4 rounded-4xl text-white px-10 bg-[#9538E2]'>Wishlist</button></NavLink>
